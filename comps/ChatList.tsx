...
//         if (isDev) console.log(`Chat ${chatId} deleted successfully`);

//         // ✅ Remove chatId from URL query
//         if (router.query.chatId === chatId) {
//           const newQuery = Object.fromEntries(
//             Object.entries(router.query).filter(([key]) => key !== "chatId")
//           );
//           router.replace(
...
//     try {
//       const res = await toggleChatArchive(chatId);
//       const updatedChat = res?.data?.data;

//       if (!updatedChat) {
//         throw new Error("No updated chat returned from server");
//       }
...
//       if (isDev)
//         console.log(
//           `Chat ${chatId} has been ${
//             updatedChat.isArchived ? "archived" : "unarchived"
//           }`
//         );
//     } catch (err) {
//       console.error("Error toggling archive:", err);
//       setError("Failed to archive/unarchive chat");
//     }
//   };

//   useEffect(() => {
//     getChatList();
//     const interval = setInterval(() => getChatList(true), 10000);
...
//       <p className={styles.messagesTitle}>Messages({chats.length})</p>
...
//               onDeleteChat={handleDeleteChat} // Pass handleDeleteChat
//             />
//           ))
//         ) : (
