...
//   //   if (!message) {
//   //     if (isDev) console.log("No message provided, refreshing chats");
//   //     getChatList(true);
//   //     return;
//   //   }
//   //   setChats((prev) => {
...
//       if (isDev)
//         console.log("Invalid message or timestamp, refreshing chats:", {
//           chatId,
//           message,
//         });
//       getChatList(true);
...
//   useEffect(() => {
//     getChatList();
//     const interval = setInterval(() => getChatList(true), 30000); // 30s polling
...
//         return;
//       }
//       updateChatWithMessage(data.chatId); // Fallback to polling
//     });
...
//       {/* {pollingLoading && (
//         <div className={styles.polling}>Updating chats...</div>
//       )} */}
//       <input
