...
// import { getUsers, getMe, createChat, User } from "../lib/api";
...
//   const [contacts, setContacts] = useState<User[]>([]); // Type as User[]
//   const [search, setSearch] = useState("");
//   const [currentUser, setCurrentUser] = useState<User | null>(null); // Type as User | null
//   const [selectedContacts, setSelectedContacts] = useState<User[]>([]); // Type as User[]
//   const [name, setName] = useState(""); // For group chat name
...
//         const currentUserData = userRes.data.data; // Store non-null user
//         setCurrentUser(currentUserData);
//         const res = await getUsers();
//         if (res.data.status === "success") {
//           setContacts(
//             res.data.data.users.filter(
//               (contact: User) => contact.id !== currentUserData.id // Use stored user
//             )
//           );
//         }
//       }
...
//     try {
//       // Handle group vs. individual chat
//       const recipient = isGroup
//         ? selectedContacts.map((c: User) => c.id).join(",") // Join IDs for group chat
//         : selectedContacts[0].id;
//       const res = await createChat({ recipient, isGroupChat: isGroup });
//       if (res.data.success) {
...
//                 )}
//                 <img
//                   src={user.profilePicture || "/assets/person.png"}
//                   alt="profile"
