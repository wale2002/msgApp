...
//   // Initialize loading as false since no async data is fetched initially
...
//     }
//     // No need to set loading here since no initial async fetch
//   }, [queryChatId]);
...
//       setLoading(true); // Set loading when validating
//       try {
...
//         <p>⚠️ {error}</p>
//         <button onClick={() => setSelectedChatId(undefined)}>
//           Go to Chat List
//         </button>
//       </div>
//     );
...
//                 Back to Chats
//               </button>
//               <ChatDetails chatId={selectedChatId} key={selectedChatId} />
//             </>
//           ) : (
...
//     undefined
//   );
//   const [messages, setMessages] = useState<Message[]>([]); // Added for message state
...
//     // Subscribe to Pusher and custom events
...
//         setMessages((prev) => {
//           const updated = prev.filter((msg) => msg.id !== message.id); // Replace optimistic message
